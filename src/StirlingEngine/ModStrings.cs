...
namespace RomenH.StirlingEngine.ModStrings
{
	public class STRINGS
	{
		public class BUILDINGS
		{
			public class STIRLINGENGINE
			{
				...
				public static LocString DESC = $"Draws up to 100 DTU/s of heat from the cell below the floor and converts it to power. The amount of heat drawn is based on the ratio of building temperature vs temperature below the floor tile.";
